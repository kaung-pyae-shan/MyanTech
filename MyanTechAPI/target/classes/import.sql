...
insert into orders (created_date, created_user_id, invoice_no, product_segment, shop_id, remarks, status) values (CURRENT_DATE, 1, '7144', 'CONSUMER', 15, 'gray', 'COMPLETED');
insert into orders (created_date, created_user_id, invoice_no, product_segment, shop_id, remarks, status) values ('2025-02-10', 1, '7143', 'CONSUMER', 11, 'black', 'PENDING');
